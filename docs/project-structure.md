...
- `pages/` contains all the pages.
  ...
  - The Docs collection actually breaks this rule, because its content is 2 layers deep. I implemented a workaround so the adventures pages follow the structure of the `content/docs/` folder.
